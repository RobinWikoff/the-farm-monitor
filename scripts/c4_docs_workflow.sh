...

{
    ...
    echo "2. Open wiki repo and pull latest changes:"
    echo "   - cd $WIKI_REPO_PATH"
    echo "   - git pull --ff-only"
    echo "3. Update Model-Architecture-and-Behavior.md in wiki to reflect C1/C2/C3/C4 and Baseline Inference Flow deltas."
    echo "4. Ensure wiki Q2 traceability links still match docs/c4 source files."
    echo "5. Commit and push wiki changes with a docs(wiki) commit message."
    echo
    echo "## Notes"
